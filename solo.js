...
const statusLabel = document.getElementById("solo-status");
...
function readConfig() {
  cols = clamp(parseInt(widthInput.value || "20", 10), 6, 80);
  rows = clamp(parseInt(heightInput.value || "16", 10), 6, 80);
  mineRate = clamp(parseFloat(mineRateInput.value || "16"), 5, 40) / 100;
